...
public class SellerListController implements Initializable, DataChangeListener {
	...
	// Método padrão do JavaFX para iniciar o comportamento das colunas
	private void initializeNodes() {
		...
		Stage stage = (Stage) Main.getMainScene().getWindow(); // obtendo as propriedades da janela principal
		tableViewSeller.prefHeightProperty().bind(stage.heightProperty()); // Vinculando as propriedades da janela principal em nosso table view department
	}
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			controller.loadAssociateObjects(); // carregar os departamentos do banco de dados
